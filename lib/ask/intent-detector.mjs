export function detectMetric(normalized, program) {
  ...
  if (
    ...
    /\b(quality|issue|issues|finding|findings|error|errors|problem|problems|defect|defects|exception|exceptions|anomaly|anomalies|invalid|mismatch|mismatches|data problem|affected records?|record impact|source system|issue owner)\b|\bdq-\d+\b/.test(
      normalized,
    )
  ) {
