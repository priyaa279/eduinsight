...
export function extractYears(question, dataset) {
	...
	const trendLanguage = /\bsince\b|\bfrom\b|\bbetween\b|\bthrough\b|\bover time\b|\btrend\b|\bhistory\b|\btrajectory\b|\bevery available\b|\bchanged?\b|\bgrowth\b|\bincrease\w*\b|\bdecrease\w*\b|\bdecline\w*\b/.test(normalized);
